...
Namespace Yahoo.API.ImageSearchResponse
    ...
    '<remarks/>
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:yahoo:srchmi"),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="urn:yahoo:srchmi", IsNullable:=false)>  _
